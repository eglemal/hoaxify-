...
public class UserControllerTest {
    ...
    public void getUsers_whenThereIsAUserInDB_receiveUserWithoutPassword() {
        ...
        Map<String, Object> entity = response.getBody().content.get(0);
        assertThat(entity.containsKey("password")).isFalse();
    }

    @Test
    public void getUsers_whenPageIsRequestedFor3ItemsPerPageWhereTheDatabaseHas20Users() {
    ...
    @Test
    public void putUser_whenValidRequestBodyFromAuthorizedUser_receiveUserVMWithUpdatedDisplayName() throws IOException {
        User user = userService.save(TestUtil.createValidUser("user1"));
        authenticate(user.getUsername());
    ...
    public void putUser_withValidRequestBodyWithTXTImageFromAuthorizedUser_receiveValidationErrorForProfileImage() throws IOException {
        ...
        authenticate(user.getUsername());
        UserUpdateVM updateUser = createValidUserUpdateVM();
        String imageString = readFileToBase64("text-txt.txt");
        updateUser.setImage(imageString);
